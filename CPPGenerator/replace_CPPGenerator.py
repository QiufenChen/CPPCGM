...
seqs = [item[0] for item in pd.read_csv(file, header=None)['Sequence'].values]
...
torch.save(generator.state_dict(), 'replace_generator.pt')
torch.save(discriminator.state_dict(), 'replace_discriminator.pt')
